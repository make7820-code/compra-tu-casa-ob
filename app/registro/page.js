  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (esRegistro) {
        ...
        // 2. Crear documento inicial en Firestore (con rol "cliente" por defecto)
        await setDoc(doc(db, "usuarios", user.uid), {
          nombre: email,
          fotoUrl: "",
          email: email,
          rol: "cliente", // "cliente" o "agente" — para subir a alguien a agente, se cambia este campo manualmente en Firebase Console
